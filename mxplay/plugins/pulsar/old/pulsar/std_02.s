...
;
MIX_VOID_8:
		put_host #FRM_VOID	;tell dsp to don't mix
...
MIX_null_vol:	
		...
		cmp.l	d3,d4
		bgt.b	spl_mix_full_buffer_nv

		st	spl_play_short(a0)

spl_mix_full_buffer_nv:
...
;-DSP BINARY CODE--------------------------------------------------------------
		even
DSP_start:	incbin	pulsar\puls_010.p56
DSP_end:
...
OLD_SS		ds.b	64+64
		even
FIRR_coeffs:	incbin	pulsar\fir_calc\firr_tab.bin
;------------------------------------------------------------------------------
 		text