...
spl_mix_no_void:
	;
		...
		cmp.l	#$12000,d0	;if < $1.2 then no 030 resampling!
		ble	mix_8_wo_res
	;
...
;
		...
		move.l	d4,d3
smfb_wo_r:
		put_host	d1	;for resampling loop
		put_host	d3	;for "decode" loop

		bra.b	msi8wores_e
msi8wores:	move.b	(a2)+,(a1)	;dsp send 8bit
...
spl_mix_wo_fali	put_host	#0
		put_host	#0
		rts
;
mix_normal_loop_wo_r
mix_ping_loop_wo_r
		put_host	#0	;vol
		put_host	#0	;pan
		put_host	#0	;scale
...
check_freq:
		cmp.l	#50*$100,d0		;minimum freq rate (to avoid receive buffer overflow)
		bge.b	freq_ok
		lsl.l	d0
