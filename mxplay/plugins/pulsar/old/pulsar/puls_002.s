...
wait_end	tst.b	$fffff8901.w
		...
		move.l	MIX_1_PTR(pc),d0
		move.l	MIX_2_PTR(pc),MIX_1_PTR
		move.l	d0,MIX_2_PTR
		...
		move.l	MIX_2_PTR(pc),d0
		moveq	#0,d1
		move.w	bufer_len(pc),d1	
		add.l	d1,d0

		move.b	d0,$ffff8913.w
		lsr.w	#8,d1
		move.l	d0,$ffff890e.w

		move.b	#%11,$ffff8901.w

		lea	P_VOICE_TAB(pc),a0
		move.l	MIX_1_PTR(pc),a1
		bsr	P_MIX_1
