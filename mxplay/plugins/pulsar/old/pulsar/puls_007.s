...
spl_no_change	moveq	#0,d1
	...
	******************************************
		...
		bls.b	mix_no_loop_reinitialize

		;move.l	spl_ptr(a0),a2
		;add.l	spl_loop_off(a0),a2	;a4=spl loop ptr
		;move.l	a2,spl_now_playing(a0)
		clr.l	d3
mix_no_loop_reinitialize:
		st	spl_loop_flag1(a0)
		bra.b	spl_mix_full_buffer
...
mix_after_samples
		...
		beq.b	mix_check_end
		subq.w	#1,d5
		bmi.b	spl_sample_not_expired

		move.l	spl_ptr(a0),a2
		add.l	spl_loop_off(a0),a2	;a4=spl loop ptr
		clr.w	d2

mix_samples_inner_1_in_loop:	move.b	(a2,d2.w),(a1)	;dsp send 8bit
		addx.l	d0,d2
		dbf	d5,mix_samples_inner_1_in_loop

		add.w	d2,a2
		move.l	a2,spl_now_playing(a0)

		bra.b	spl_sample_not_expired

mix_check_end:	tst.b	spl_play_short(a0)
