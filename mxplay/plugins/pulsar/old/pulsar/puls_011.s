...
spl_volume_gz	put_host	#1	;tell dsp to mix 8bit as input
...
MIX_EXIT_2	put_host	#0
MIX_EXIT_2_a	get_host	d0
		cmp.l	#"OK!",d0
		beq.b	MIX_EXIT_2_OK
dupa_2
		moveq	#2,d0		
...
***********************************************************************************
mix_ping_loop:		lea	$fffffa207.w,a1	;host adr -> a1
;		illegal
...
MIX_EXIT_2_OK_pp:
		...
		put_host	#0
MIX_EXIT_2_pp_a	get_host	d0
		cmp.l	#"OK!",d0
		beq.b	MIX_EXIT_2_OK_pp2
dupa_3
		moveq	#3,d0		
		illegal
...
spl_volume_gz_2	put_host	#2	;tell dsp to take 16bit as input
...
MIX_EXIT_16	put_host	#0
MIX_EXIT_16_a	get_host	d0
		cmp.l	#"OK!",d0
		beq.b	MIX_EXIT_162
...
MIX_EXIT_2_16
		put_host	#0
MIX_EXIT_2_16_a	get_host	d0
		cmp.l	#"OK!",d0
		beq.b	MIX_EXIT_2_16_
dupa_5
		moveq	#5,d0		
		illegal
MIX_EXIT_2_16_:
...
MIX_EXIT_2_16_pp:	;illegal
		put_host	#0
MIX_EXIT_2_pp_16_a	get_host	d0

		cmp.l	#"OK!",d0
		beq.b	MIX_EXIT_2_16_pp3
dupa_6
		moveq	#6,d0		
		illegal
MIX_EXIT_2_16_pp3		rts
;*******************************************************************************
;
;
...
timer_exit	bclr	#5,$fffffa0b.w		;mask off timer A
		move.w	#100,cpu_power
		rte
...
;-DSP BINARY CODE--------------------------------------------------------------
		even
DSP_start:	incbin	g:\pulsar\puls_006.p56
DSP_end:
