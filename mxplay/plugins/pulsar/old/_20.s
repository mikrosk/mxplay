...
XM_play_vol:	equ	4
XM_old_period:	equ	6
XM_play_period:	equ	10
XM_play_note:	equ	12
XM_old_note:	equ	14
XM_pulsar_vol:	equ	16
XM_fadeout:	equ	18
XM_venv_vol:	equ	20
XM_vsld:	equ	22
XM_porta:	equ	24
...
XM_appreg_2:	equ	34
XM_appreg_3:	equ	36
XM_appreg_flag:	equ	38
XM_temp_period	equ	40
XM_vib_last:	equ	42
XM_vib_depth2:	equ	44
XM_vib_pos:	equ	46
XM_vib_rate2:	equ	48
XM_vib_flag:	equ	50
XM_tone_last:	equ	52
XM_org_period	equ	54
XM_tone_flag:	equ	58
XM_tone_speed:	equ	60
XM_tremolo_depth:equ	62
XM_tremolo_pos:	equ	64
XM_tremolo_rate:equ	66
XM_tremolo_flag:equ	68
XM_tremolo_last:equ	70
XM_temp_vol	equ	72
XM_retrig_flag:	equ	74
XM_retrig_count:equ	76
XM_retrig_int:	equ	78
XM_Sample_ptr:	equ	80
XM_fine_vl:	equ	84
XM_fine_vl2:	equ	86
XM_fine_pl:	equ	88
XM_Sample_len:	equ	90
XM_vib_wave:	equ	94
XM_tremolo_wave:equ	98
XM_wave_flags:	equ	102
XM_inst_ptr:	equ	106
XM_spl_h_ptr:	equ	110
XM_cut_flag:	equ	114
_note		equ	116
_instrument	equ	117
_volume		equ	118
...
_even_1:	equ	121
_even_2		equ	123
XM_dont_flag:	equ	124
XM_note_period:	equ	126
XM_spl_force:	equ	130
XM_offset_ptr:	equ	132
XM_offset_flag:	equ	136
XM_was_flag:	equ	138
XM_ftune:	equ	140
XM_spl_raw_ptr:	equ	142
XM_const_period:equ	146
XM_inst_init:	equ	150

XM_venv_pts:	equ	154
XM_venv_time:	equ	156
XM_venv_ltime:	equ	158
XM_venv_lsize:	equ	160
XM_venv_sus_flag:equ	162

XM_penv_pts:	equ	164
XM_penv_time:	equ	166
XM_penv_ltime:	equ	168
XM_penv_lsize:	equ	170
XM_penv_sus_flag:equ	172

XM_voice_vol:	equ	174

XM_delay_flag:	equ	176
XM_key_off:	equ	178

channel_size:	equ	179
...
XM_spl_fine:	equ	13
XM_spl_type:	equ	14
XM_spl_panning	equ	15
XM_spl_rnn:	equ	16
XM_spl_res:	equ	17
XM_spl_name:	equ	18	;<-string
...
;-------------------------------------------------------------------------------
		...
		jmp	start
		include	g:\include\sys_lib.s
		include	g:\include\unpack3.s
		include	g:\pulsar\puls_020.s
		text
...
************************************************************************************************
*                                       -Init XM-                                              *
*      Makes whole module Morotola compatibile, initialize samples, fill player structures     *
************************************************************************************************
XM_init_module:
...
clear_channels:	move.l	a1,a0
		...
		lea	XM_Wave_sin(pc),a2
		move.l	a2,(a0)+	~| Initialize wave for vibrato
		move.l	a2,(a0)+	~| Initialize wave for tremolo
		move.l	a2,XM_vib_wave(a1)
		move.l	a2,XM_tremolo_wave(a1)
...
XM_init_sound:	;illegal
		...
		move.l	#XM_OPEN_INT,d3	;procedure called by the PULSAR
		move.l	#XM_CLOSE_INT,d4
		move.w	channel_Nb(pc),d5		;Nb of channels
...
;
;	NOTE: it has to be ended by _RTS_
;נננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננננ
...
XM_Song_ok:	move.w	5(a0),patt_rows
		add.w	#9,a0
		move.l	a0,Playing_pat
		move.l	a1,Order_ptr
...
XM_do_rslv1
		...
		pop.l	a0
XM_no_resolve
		add.l	#spl_size,a1	;move to next pulsar channel
		add.l	#channel_size,a2
...
XM_ptr_update:	move.l	a0,Playing_pat
...
XM_Song_ok_:	move.w	5(a0),patt_rows
	...
	;~~~~~~~~| SELECT RELPAY POSITION |~~~~~~~~~
		...
		lea	XM_skip_tab,a1	~| Now this tab will be useful! |~
		moveq	#0,d0
XM_position_loop:
		move.w	d7,d5
XM_line_loop_pb:	move.b	(a0),d0	~| What have we get there? |~
...
XM_Vib_cont:	move.b	_value(a2),d0

		btst	#2,d0		~| test for wave retrig
		beq.b	XM_vib_no_retrig
		bset	#XM_Vib_retrig,XM_wave_flags(a2)	~| Retrig wave on
		bra.b	XM_vib_set_wave
XM_vib_no_retrig:bset	#XM_Vib_retrig,XM_wave_flags(a2)	~| Retrig wave off
XM_vib_set_wave:
		and.b	#%11,d0
		cmp.b	#0,d0
		bne.b	XM_vib_try_ramp
		move.l	#XM_Wave_sin,XM_vib_wave(a2)
		rts
XM_vib_try_ramp:
		cmp.b	#1,d0
		bne.b	XM_vib_try_sqware
		move.l	#XM_Wave_rampdown,XM_vib_wave(a2)
		rts
XM_vib_try_sqware:
		cmp.b	#2,d0
		bne.b	XM_vib_try_to_shit_on		~| stupid user !!!!!
		move.l	#XM_Wave_sqware,XM_vib_wave(a2)
XM_vib_try_to_shit_on:
		rts

	;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	;	Tremolo Control

XM_tremolo_cont:move.b	_value(a2),d0

		btst	#2,d0		~| test for wave retrig
		beq.b	XM_tremolo_no_retrig
		bset	#XM_tremolo_retrig,XM_wave_flags(a2)	~| Retrig wave on
		bra.b	XM_vib_set_wave
XM_tremolo_no_retrig:bset	#XM_tremolo_retrig,XM_wave_flags(a2)	~| Retrig wave off
XM_tremolo_set_wave:
		and.b	#%11,d0
		cmp.b	#0,d0
		bne.b	XM_tremolo_try_ramp
		move.l	#XM_Wave_sin,XM_vib_wave(a2)
		rts
XM_tremolo_try_ramp:
		cmp.b	#1,d0
		bne.b	XM_tremolo_try_sqware
		move.l	#XM_Wave_rampdown,XM_vib_wave(a2)
		rts
XM_tremolo_try_sqware:
		cmp.b	#2,d0
		bne.b	XM_tremolo_try_to_shit_on	~| stupid user !!!!!
		move.l	#XM_Wave_sqware,XM_vib_wave(a2)
XM_tremolo_try_to_shit_on:
		rts
	;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
XM_run_vib:
		...
		pusha
		move.l	XM_temp_period(a2),d0
		
		move.w	XM_vib_pos(a2),d1
		;lsr.w	#1,d1

		moveq	#0,d2
		move.l	XM_vib_wave(a2),a3
		move.b	(a3,d1.w),d2
		ext.w	d2
		muls.w	XM_vib_depth2(a2),d2
		asr.l	#5,d2
...
XM_calc_period:	moveq	#0,d1
		...
		subq.w	#1,d0
		move.l	#10*12*16*4,d2		;(10*12*16*4) - (Note*16*4)
		and.l	#$7f,d0
		asl.l	#6,d0
		sub.l	d0,d2
		moveq	#0,d0
...
XM_Wave_sin:	dc.b	$00,$00,$18,$18,$31,$31,$4a,$4a,$61,$61,$78,$78,$8d,$8d,$a1,$a1
		dc.b	$b4,$b4,$c5,$c5,$d4,$d4,$e0,$e0,$eb,$eb,$f4,$f4,$fa,$fa,$fd,$fd
		dc.b	$ff,$ff,$fd,$fd,$fa,$fa,$f4,$f4,$eb,$eb,$e0,$e0,$d4,$d4,$c5,$c5
		dc.b	$b4,$b4,$a1,$a1,$8d,$8d,$78,$78,$61,$61,$4a,$4a,$31,$31,$18,$18
		even
XM_Wave_rampdown:
		dc.b	$ff,$ff,$ff,$ff,$e0,$e0,$e0,$e0	~| ramp wave tabel |~
		dc.b	$d0,$d0,$c0,$c0,$b0,$b0,$a0,$a0
		dc.b	$90,$90,$90,$90,$80,$80,$80,$80
		dc.b	$70,$70,$70,$70,$60,$60,$60,$60
		dc.b	$50,$50,$50,$50,$40,$40,$40,$40
		dc.b	$30,$30,$30,$30,$20,$20,$20,$20
		dc.b	$10,$10,$10,$10,$00,$00,$00,$00
		even

XM_Wave_rampup:	dc.b	$ff,$ff,$ff,$ff,$e0,$e0,$e0,$e0 ~| ramp up wave |~
		dc.b	$d0,$d0,$c0,$c0,$b0,$b0,$a0,$a0
		dc.b	$90,$90,$90,$90,$80,$80,$80,$80
		dc.b	$70,$70,$70,$70,$60,$60,$60,$60
		dc.b	$50,$50,$50,$50,$40,$40,$40,$40
		...
		even
XM_Wave_sqware:	
		dc.b	$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff	~| And now very |~
		dc.b	$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ~| complicated  |~
		dc.b	$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ~| Sqware tab:) |~
...
mod		;incbin	f:\dwojka3.xm
		...
		;incbin	e:\xm'ms\cdremai2.xm
		;incbin	e:\scena\mods\xm's\apptough.xm
		;incbin	e:\scena\mods\xm's\propagan.xm
		incbin h:\mods\mods\part1\xm\arnomnia.xm
		;incbin h:\mods\mods\part1\xm\sunflow_.xm
