...
#define MXP_FLG_INFOLINE		(1<<30)			/* show on infoline, too */
#define MXP_FLG_MOD_PARAM		(1<<31)			/* module parameter else plugin parameter */
...
extern char					g_currModuleName[FILENAME_MAX];
...
extern char*				AudioPluginGetInfoLine( void );
extern BOOL					AudioPluginCheckHeader( void );
...
extern void					AudioPluginCheckFunctions( struct SAudioPlugin* plugin );
